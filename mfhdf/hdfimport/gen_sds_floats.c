...
int main()
{
    ...
    float32 in2_data[X_LENGTH][Y_LENGTH]={ /* input for 2-dim SDS */
      ...
      {  0.0,  0.0,600.0,600.0,300.0,400.0,      500.0,500.0},
      {600.0,600.0,300.0,400.0,  0.0,  0.0,600.0,600.0,300.0},
      /* TODO: What is this extra value???? 400.0 */
    };
    float32 in3_data[X_LENGTH][Y_LENGTH][Z_LENGTH]={ /* input for 3-dim SDS */
      {{100.0,100.0},{200.0,200.0},{300.0,400.0},{100.0,100.0},{200.0,200.0},{300.0,400.0},{100.0,100.0},{200.0,200.0},{300.0,400.0}},
      {{300.0,300.0},{  0.0,400.0},{300.0,400.0},{300.0,300.0},{  0.0,400.0},{300.0,400.0},{300.0,300.0},{  0.0,400.0},{300.0,400.0}},
      {{  0.0,  0.0},{600.0,600.0},{300.0,400.0},{500.0,500.0},{600.0,600.0},{300.0,400.0},{  0.0,  0.0},{600.0,600.0},{300.0,400.0}},
      {{1.0,1.0},{2.0,2.0},{3.0,4.0},{1.0,1.0},{2.0,2.0},{3.0,4.0},{1.0,1.0},{2.0,2.0},{3.0,4.0}},
      {{3.0,3.0},{0.0,4.0},{3.0,4.0},{3.0,3.0},{0.0,4.0},{3.0,4.0},{3.0,3.0},{0.0,4.0},{3.0,4.0}},
      {{0.0,0.0},{6.0,6.0},{3.0,4.0},{5.0,5.0},{6.0,6.0},{3.0,4.0},{0.0,0.0},{6.0,6.0},{3.0,4.0}}
    };
